...
/* 20. Dados três vaçpres, A, B, C, verificar se eles podem ser valores dos lados de um triângulo e,
...
int main() {
    ...
    if (opcao == 1) media = (n1 * n2 * n3) / 3;
    else if (opcao == 2) media = (n1 + (n2 * 2) + (n3 * 3) / 6);
    else if (opcao == 3) media = (1 / (1 / n1) + (1 / n2) + (1 / n3));
    else if (opcao == 4) media = (n1 + n2 + n3) / 3;
